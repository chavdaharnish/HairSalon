...
public class ImageActivity extends AppCompatActivity implements ImageAdapter.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new ImageAdapter(ImageActivity.this, ImageActivity.this, mUploads);
        ...
        mDatabaseRef = FirebaseDatabase.getInstance().getReference("HAIRSTYLIST").child(Main3Activity.key).child("Hairstyles");
